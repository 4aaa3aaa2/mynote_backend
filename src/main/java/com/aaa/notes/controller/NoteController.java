...
import com.aaa.notes.model.vo.note.CreateNoteVO;
import com.aaa.notes.model.vo.note.DownloadNoteVO;
import com.aaa.notes.model.vo.note.NoteHeatMapItem;
import com.aaa.notes.model.vo.note.NoteRankListItem;
import com.aaa.notes.model.vo.note.NoteVO;
import com.aaa.notes.model.vo.note.Top3Count;
import com.aaa.notes.service.NoteService;
...
public class NoteController {
    ...
    public ApiResponse<EmptyVO> updateNote(
            @Min(value = 1, message = "noteId must be positive integer") @PathVariable Integer noteId,
    ...
    public ApiResponse<EmptyVO> deleteNote(
            @Min(value = 1, message = "noteId must be positive integer")
