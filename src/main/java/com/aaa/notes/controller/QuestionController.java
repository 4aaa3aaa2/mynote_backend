...
public class QuestionController {
    ...
    public ApiResponse<List<QuestionUserVO>> userGetQuestions(
            @Valid QuestionQueryParam queryParams) {
    ...
    public ApiResponse<List<QuestionVO>> searchQuestions(
            @Valid @RequestBody SearchQuestionBody body) {
    ...
    public ApiResponse<QuestionNoteVO> userGetQuestion(
            @Min(value = 1, message = "questionId must be positive integer") @PathVariable Integer questionId) {
    ...
    public ApiResponse<List<QuestionVO>> getQuestions(
            @Valid QuestionQueryParam queryParams) {
    ...
    public ApiResponse<CreateQuestionVO> createQuestion(
    ...
    public ApiResponse<EmptyVO> createQuestions(
            @RequestBody CreateQuestionBatchBody createQuestionBatchBody) {
    ...
    public ApiResponse<EmptyVO> updateQuestion(
            @Min(value = 1, message = "questionId 必须为正整数") @PathVariable Integer questionId,
    ...
    public ApiResponse<EmptyVO> deleteQuestion(
            @Min(value = 1, message = "questionId 必须为正整数") @PathVariable Integer questionId) {
