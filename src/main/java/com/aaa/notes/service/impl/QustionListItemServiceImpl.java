...
import com.aaa.notes.model.dto.questionListItem.CreateQuestionListItemBody;
import com.aaa.notes.model.dto.questionListItem.QuestionListItemQueryParams;
import com.aaa.notes.model.dto.questionListItem.SortQuestionListItemBody;
import com.aaa.notes.model.entity.QuestionList;
import com.aaa.notes.model.entity.QuestionListItem;
import com.aaa.notes.model.vo.questionListItem.CreateQuestionListItemVO;
import com.aaa.notes.model.vo.questionListItem.QuestionListItemUserVO;
import com.aaa.notes.model.vo.questionListItem.QuestionListItemVO;
import com.aaa.notes.scope.RequestScopeData;
import com.aaa.notes.service.QuestionListItemService;
...
@Log4j2
@Service
public class QustionListItemServiceImpl implements QuestionListItemService {
    @Autowired
    ...
    public ApiResponse<List<QuestionListItemUserVO>> userGetQuestionListItems(QuestionListItemQueryParams queryParams) {
        ...
        List<QuestionListItemVO> questionListItems = questionListItemMapper.findByQuestionListIdPage(
        ...
        List<QuestionListItemUserVO> list = questionListItems.stream().map(questionListItemVO -> {
            ...
            questionListItemUserVO.setUserQuestionStatus(userQuestionStatus.isFinished());

            return questionListItemUserVO;
        }).toList();

        return ApiResponseUtil.success("got user question list item ", list, pagination);
    }
    ...
    public ApiResponse<List<QuestionListItemVO>> getQuestionListItems(Integer questionListId) {
        ...
        return ApiResponseUtil.success("got question list item", byQuestionListId);
    }
    ...
    public ApiResponse<CreateQuestionListItemVO> createQuestionListItem(CreateQuestionListItemBody body) {
        ...
        try {
            ...
            return ApiResponseUtil.success("create question list item", createQuestionListItemVO);
        } catch (Exception e) {
            return ApiResponseUtil.error("create question list item fail");
        }
    }
    ...
    public ApiResponse<EmptyVO> deleteQuestionListItem(Integer questionListId, Integer questionId) {
        ...
        try {
            ...
            return ApiResponseUtil.success("delete question list item");
        } catch (Exception e) {
            return ApiResponseUtil.error("delete question list item failed");
        }
    }
    ...
    public ApiResponse<EmptyVO> sortQuestionListItem(SortQuestionListItemBody body) {
        ...
        try {
            ...
            return ApiResponseUtil.success("question list item rank");
        } catch (Exception e) {
            return ApiResponseUtil.error("question list item rank failed");
        }
    }
